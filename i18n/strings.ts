...
export const strings: Record<string, Record<Language, string>> = {
  ...
  submitted:         { ar: 'تم تقديم البلاغ', fr: 'Soumis' },
  underInvestigationTimeline: { ar: 'قيد التحقيق والبحث', fr: 'Sous enquête' },
  leaderAssignedTimeline: { ar: 'تم تعيين قائد الفريق', fr: 'Chef d\'équipe assigné' },
  workInProgressTimeline: { ar: 'أشغال قيد التنفيذ', fr: 'Travaux en cours' },
  resolvedTimeline:  { ar: 'تم حل المشكلة', fr: 'Résolu' },
  ...
  openOpenStreetMap: { ar: 'فتح في خريطة الشارع المفتوحة', fr: 'Ouvrir dans OpenStreetMap' },
  viewRoute:         { ar: 'عرض المسار إلى المشكلة (داخل التطبيق)', fr: "Voir l'itinéraire vers le problème" },
  closeMap:          { ar: 'إغلاق الخريطة', fr: 'Fermer la carte' },
  calculatingRoute:  { ar: 'جاري حساب المسار...', fr: "Calcul de l'itinéraire en cours..." },
